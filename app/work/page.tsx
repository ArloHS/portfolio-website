...
const workData = [{
  id: "artefact", company: "Artefact (prev AdvanceGuidance)", logo: "/images/artefact.jpg", role: "Senior Machine Learning Engineer", startDate: "2026-09", endDate: null, location: "South Africa",
  ...
  id: "unifi-africa", company: "Unifi Africa", logo: "/images/unifi.png", role: "Data Scientist", startDate: "2026-01", endDate:"2026-09", location: "South Africa",
  companyDescription: "Unifi is a technology-led lending business that provides accessible personal credit across African markets. Its operating model combines digital products, local country teams, credit governance, and data-driven decision-making to manage portfolios responsibly at scale. Working across five country portfolios meant that the analytical work had to be both technically robust and operationally useful: models needed to perform in production, risk decisions needed clear governance, and insights needed to make sense in each local market.",
